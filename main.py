...
if __name__ == "__main__":
    ...
    train_dataloader, val_dataloader, test_dataloader = shuffle_split_load_dataset(custom_dataset, batch_size=1024, val_split=0.1, test_split=0.1)
    ...
    model, train_losses, val_losses, model_val_loss = train_and_evaluate(train_dataloader=train_dataloader, val_dataloader=val_dataloader,
                                                                         ...
                                                                         scheduler=scheduler, device="cuda", num_epochs=1, eval_frequency=100000, max_val_batches=10000,
