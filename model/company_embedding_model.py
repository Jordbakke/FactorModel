...
class CompanyEmbeddingModel(nn.Module):
    def __init__(self, price_model, fundamentals_model, company_description_model, head_combination_model):
...
if __name__ == "__main__":
    ...
    fixed_company_features = torch.randn(4, 1, 30)
    result = company_embedding_model(prices, fundamentals, company_description, fixed_company_features)
    print(result.shape)
    #summary(company_embedding_model, input_size=[(2, 5, 6), (2, 2, 124), (2, 1, 1536)])
