...
Style: Write in present tense, as if you went back in time to the end of the given year and quarter and wrote the business description at that time. The business model description must be strictly factual, concise, and straighforward. Use the minimum number of tokens necessary to convey the details. The description CANNOT exceed 300 words so avoid any. The language must be simple, clear, and straightforward, focusing only on concrete information. Avoid stylistic or descriptive phrases.
...
if __name__ == "__main__":
    ...
    example_companies = ["MSFT-US", "RIG-US", "HIMS-US", "VAL-US"]
    ...
    user_message["content"] = user_message["content"].format("Transocean", "RIG-US", "Q2", "2023")
