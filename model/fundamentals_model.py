...
class FundamentalsModel(nn.Module):
    ...
    def __init__(self, embedding_dim, num_heads, ffnn_hidden_dim, num_ffnn_hidden_layers, activation_function=nn.GELU, ffnn_dropout_prob=0.1,
                attention_dropout_prob=0.1, batch_first=True, num_encoder_blocks=3, force_inner_dimensions=True, max_seq_len=1000, prepend_embedding_vector=False):
        ...
        self.transformer_model = Encoder(embedding_dim=embedding_dim, num_heads=num_heads, ffnn_hidden_dim=ffnn_hidden_dim,
                                                      ...
                                                      num_transformer_blocks=num_encoder_blocks, force_inner_dimensions=force_inner_dimensions)
    ...
    def forward(self, x):
        ...
        return self.transformer_model(positional_embedded_x)
