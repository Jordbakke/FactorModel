...
if __name__ == "__main__":
    ...
    df = pd.DataFrame({"date": ["2021", "2022"], "val": [0, 1]})

    df = log_ratio_transform(df, cols_to_transform=["val"], shift_value=1, inplace=False, new_column_names=["val_log_ratio"], drop_original_cols=False)
    print(df)