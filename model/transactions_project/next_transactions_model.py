...
class NextTransactionsModel(nn.Module):
    ...
    def __init__(self, embedding_dim, num_heads, ffnn_hidden_dim, output_dim, num_ffnn_hidden_layers, ffnn_dropout_prob=0.1,
        ...
        self.ffnn = utils.FFNN(embedding_dim=embedding_dim, hidden_dim=ffnn_hidden_dim, output_dim=output_dim,
