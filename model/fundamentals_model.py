...
class FundamentalsModel(nn.Module):
    ...
    def __init__(self, embedding_dim, num_heads, ffnn_hidden_dim, num_ffnn_hidden_layers, num_feature_hidden_layers=2, num_masked_hidden_layers=2,
        ...
        self.masked_network = utils.MaskedNetwork(embedding_dim=embedding_dim, hidden_dim=embedding_dim, num_feature_hidden_layers=num_feature_hidden_layers,
                                                  output_dim=embedding_dim, activation_function=nn.GELU, dropout_prob=0.1, dropout_layer_frequency=2,
                                                  num_masked_hidden_layers=num_masked_hidden_layers)
