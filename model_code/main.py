...
from model.custom_loss_functions import embedding_correlation_cosine_loss
from model.test_train import train_and_evaluate, evaluate_and_save, shuffle_split_load_dataset
...
if __name__ == "__main__":
    ...
    text_params = (sum(p.numel() for p in company_embedding_model.company_description_model.parameters()))
    print(total_params, text_params)
