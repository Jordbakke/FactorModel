...
class OpenaiModel:
    ...
    def post_batch_job(self, request_units: list, batch_job_ids_file_path: str, is_chat_completion_request: bool,
                        file_name: str, overwrite_preexisting_batch_jobs: bool, max_batch_size: int = 50000):
    ...
    @staticmethod
    def store_batch_results(batch_results: list, is_chat_completion: bool, custom_id_col: str, content_col: str, preexisting_file_path: str = None, storage_file:str = None):
