...
def embedding_correlation_dot_product_loss(embedding1: torch.tensor, embedding2: torch.tensor, target_correlation: torch.tensor, target_dot_product: torch.tensor, correlation_weight: torch.tensor, dot_product_weight: torch.tensor):
    """
...
if __name__ == "__main__":
    ...
    loss = embedding_correlation_dot_product_loss(t1, t2, torch.tensor([1.0, 1.0]), torch.tensor([2.0, 2.0]), torch.tensor(0.7), torch.tensor(0.3))
    print(loss)
