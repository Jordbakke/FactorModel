...
if __name__ == "__main__":
    ...
    example_companies = ["MSFT-US", "RIG-US", "HIMS-US"]
    ...
    # response = openai_model.retrieve_batch("batch_675d8a712350819094eedaaa5587fb02")
    # print(response)
    ...
    # user_message["content"] = user_message["content"].format("Alibaba", "BABA-US", "Q4", "2019")
