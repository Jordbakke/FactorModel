...
class FundamentalsModel(nn.Module):
    ...
    def __init__(self, embedding_dim, num_heads, ffnn_hidden_dim, num_ffnn_hidden_layers, activation_function=nn.GELU, ffnn_dropout_prob=0.1,
                attention_dropout_prob=0.1, batch_first=True, num_transformer_blocks=3, force_inner_dimensions=True, max_seq_len=1000, prepend_embedding_vector=False):
        ...
        self.positional_encoding = PositionalEmbedding(embedding_dim, max_seq_len=max_seq_len)
