...
class OpenaiModel:
    ...
    @staticmethod
    def store_batch_results(batch_results: list, is_chat_completion: bool, custom_id_col: str, content_col: str, storage_file:str = None):
...
if __name__== "__main__":
    ...
    input_ids, attention_mask = model.batch_encode_texts([t1, t2], padding="max_length", max_length=512)
