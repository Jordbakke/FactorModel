...
from data.processing.llm_utils import OpenaiModel, HuggingFaceModel
...
def process_target_data(prices_df: pd.DataFrame, periods=3, sequence_length: int = 4) -> pd.DataFrame:
    ...
    data_utils.open_in_excel(target_df, "prices")
    ...
    data_utils.open_in_excel(target_df, "corr")
    ...
    data_utils.open_in_excel(target_df, "standardized_corr")
